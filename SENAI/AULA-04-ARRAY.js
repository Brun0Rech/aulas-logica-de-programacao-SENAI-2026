...
// → Seu código aqui:
const cores = ["vermelho","azul","branco","preto"]
console.log(cores[0])
console.log(cores[3])
...
// → Seu código aqui:
let tudo = [1,true,"bruno", 180]
console.log(tudo, tudo.length)
...
let listageral = ["rech","senai",18,false,null]
console.log(listageral)
listageral.pop()
listageral.shift()
console.log(listageral)
listageral.push("careca")
console.log(listageral)
